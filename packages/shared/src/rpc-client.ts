 ...
 */
async function rawRpcCall<T>(creds: RpcCredentials, method: string, params: unknown[]): Promise<T | null> {
 ...
 */
export async function rpcCall<T = unknown>(chain: string, method: string, params: unknown[] = []): Promise<T | null> {
